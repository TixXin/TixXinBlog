...
> 历史归档：原文来自 `docs/motion-audit/remediation-prompt.md`，保留当时的设计、实施与验收事实。文中的阶段、版本、数量和“当前／下一步”不代表现状；现行入口见[文档导航](../../../README.md)。本机验收产物仍按原仓库相对路径留存。
...
- D:/Projects/TixXinBlog/docs/archive/ui/motion-audit/report.md
- D:/Projects/TixXinBlog/docs/archive/ui/motion-audit/findings.json
- D:/Projects/TixXinBlog/docs/archive/ui/motion-audit/inventory.md
- D:/Projects/TixXinBlog/docs/archive/ui/motion-audit/coverage.md
- D:/Projects/TixXinBlog/docs/archive/ui/motion-audit/motion-spec.md
