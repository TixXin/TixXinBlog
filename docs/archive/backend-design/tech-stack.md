...
> 历史归档：原文来自 `docs/backend/tech-stack.md`，保留当时的设计、实施与验收事实。文中的阶段、版本、数量和“当前／下一步”不代表现状；现行入口见[文档导航](../../README.md)。本机验收产物仍按原仓库相对路径留存。
...
事件清单见 [api.md 第 7.17 节](api.md#717-notificationswebsocket)。
