...
两组补种前分别完整备份 `.backups/backup-1789117524856-e9fe1a03/` 与 `.backups/backup-1789117527664-f2a33fda/`，迁移前备份 `.backups/backup-1789116156816-0a7af66b/`，均本机长期保留。日常目标仍为 `127.0.0.1:15433/tixxin_blog`：32迁移、74文章、20项目、24图库、54留言、17媒体、90媒体引用、262归属；其他业务原有内容保留。新增素材运行位置仍为 `src/backend/server-main/var/media/`，原素材在 `src/seeders/gallery-assets/`。
