...
`editorial:prepare refresh --apply --confirm tixxin_blog` 已在完整备份 `.backups/backup-1789128368974-3eec9547/` 后更新精确匹配的既有候选：文章70/71/72保留编号和历史，版本从1到2；项目19从0到1。四项均为草稿，各有3条内部关系；首篇草稿置顶，尚未公开。重复执行 `changed=false`、`updated=[]`，没有重复内容或第二次写入。日常总数仍为74文章、20项目、24图库、54留言、17媒体、90引用、262归属，33迁移零漂移。

当前最终完整备份 `.backups/backup-1789128672264-dd66b674/` 校验17/17媒体，并登记运行任务 `93aa0fa9-ce7d-4abc-ab26-75f5c5454198`。日常26项任务为23项暂停邮件与3次手动备份，邮件尝试仍为0；自动调度未启用。首发v9子包与审阅清单在本机 `.artifacts/first-release/content-43198f0d-f180-4f94-bfe6-a60d7d9781bb/`，只有3文章、1项目、12关联、1栏目、2标签、零媒体；迁入需关闭配置。工具与保护规则见 [个人内容](personal-content.md)，整体验收见 [首发准备](first-release-readiness.md)。以下较早批次的数量与备份保留当时状态。

## 可持续运营阶段增量（已完成）

已补齐 `writing-v1` 6条归属：1篇万字公开维护手册、1篇草稿、1项目、2图库作品（1公开/1撤回）和1媒体。三域有向关联可在日常页面继续浏览；草稿目标仅管理端可见。新素材复用已登记来源的 Unsplash 城市图片，说明保留出处，不宣称博主原创摄影。`check-data --domain writing` 核对长文、草稿、关联与归属。

已补齐 `notifications-v1` 71条归属：23条自然留言、2条博主回复、23条通知、23项暂停邮件任务。实际通知21未读/2已读，涵盖待审、待回复、已回复与隐藏；默认20条分页有第二页。`check-data --domain notifications` 核对记录、日期和归属。种子通过真实业务生成事件；通用旧样本补种不回放历史通知，通知专用种子即使环境已启用邮件也强制暂停其邮件任务，永不自动向真实地址投递。
