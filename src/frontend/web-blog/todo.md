...
- 本轮七项，已完成 0 项；P0 进行中，P1/P2 已开始基线核对。
- 实现、数据、维护兼容、验证、文档和提交逐项验收；历史完成率不计入本轮。
- 清单、事实确认与授权边界见 [阶段跟踪](../../../docs/sustainable-blog-stage.md)。
...
P0 真实个人资料与统一运营工作台进行中，完整七项范围见阶段跟踪。
...
- [ ] 友链公开申请、邮件通知、自动探活和站点资料抓取，另行明确流程及授权。
